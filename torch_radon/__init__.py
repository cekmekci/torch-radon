...
class BaseRadon(abc.ABC):
    ...
    def filter_sinogram(self, sinogram, filter_name="ramp"):
        ...
        sino_fft = torch.view_as_real(torch.fft.fft2(padded_sinogram, norm="ortho"))
        ...
        # Inverse fft
        filtered_sinogram = torch.fft.ifft2(torch.view_as_complex(filtered_sino_fft), norm="ortho")
